    <div class="wrapper z-30 hidden md:block">
        <!-- background ornament -->
        <div class="absolute -left-52 -top-18 z-10">
            ...
            <div class="grid md:grid-cols-2 items-center justify-between gap-10">
                <div>
                    ...
                    <div class="text-lg font-normal text-dark-2 dark:text-subtleGrey-5 md:text-base mt-4">
                        Bash - Keep an eye on your finances. Make Your Inventory <br class="hidden md:block"> Your Own.
                        From
                        One Location, All.
                    </div>
                </div>
