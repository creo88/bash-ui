                    ...
                    <form method="post" action="{{route('update.password')}}">
                        ...
                        <div class="">
                            <div class="col-lg-6 col-sm-6 form-group">
                                ...
                                <input class="form-control @error('current_password') is-invalid @enderror" name="current_password" type="password" id="current_password" required autocomplete="current_password">
                            ...
                            <div class="col-lg-6 col-sm-6 form-group">
                                ...
                                <input class="form-control @error('password') is-invalid @enderror" name="new_password" type="password" required autocomplete="new-password" id="new_password">
                                @error('new_password')
                                <span class="invalid-feedback text-danger text-xs" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-6 col-sm-6 form-group">
                                ...
                                <input class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" type="password" required autocomplete="new-password" id="confirm_password">
                            </div>
                            <div class="col-lg-12 text-end">
                                <input type="submit" value="{{__('Save Changes')}}" class="btn btn-print-invoice  btn-primary m-r-10">
                            </div>
