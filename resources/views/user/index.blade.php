                                    ...
                                    <div class="mt-4">
                                        <div class="row justify-content-between align-items-center">
                                            ...
                                            <div class="col-6 text-center Id mb-2 ">
                                                <a href="#" data-url="{{ route('plan.upgrade',$user->id) }}" data-size="lg" data-ajax-popup="true" class="btn small--btn btn-outline-primary text-sm" data-title="{{__('Upgrade Plan')}}">{{__('Upgrade Plan')}}</a>
                                            </div>
