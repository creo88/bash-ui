                        ...
                        <div data-v-7d9d14b5="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('RETAINER')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Models\Utility::retainerNumberFormat($settings,$retainer->retainer_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Models\Utility::dateFormat($settings,$retainer->issue_date)}}</p>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-66">
                                        ...
                                        @if(!empty($customFields) && count($retainer->customField)>0)
                                            @foreach($customFields as $field)
                                                {{$field->name}} : {{!empty($retainer->customField)?$retainer->customField[$field->id]:'-'}}
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
