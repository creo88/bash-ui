                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: {{$color}};color:{{$font_color}}">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right" style="position: relative;">
                                        <div data-v-f2a183a6="" class="d-title">{{__('RETAINER')}}</div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="" style="position: relative">
                                            <tr>
                                                <td>{{__('Number')}}:</td>
                                                <td>{{\App\Models\Utility::retainerNumberFormat($settings,$retainer->retainer_id)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{\App\Models\Utility::dateFormat($settings,$retainer->issue_date)}}</td>
                                            </tr>
