                        ...
                        <div data-v-e23d9750="" class="d" style="width: 770px; margin-left: 30px; margin-right: 0;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color:{{$font_color}}">{{__('RETAINER')}}</h1></div>
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-end">{{\App\Models\Utility::proposalNumberFormat($settings,$retainer->proposal_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                            ...
                                            <tr class="ml-8" style="">
                                                <td class="">
                                                    <p> {!! DNS2D::getBarcodeHTML(route('pay.proposalpay',\Illuminate\Support\Facades\Crypt::encrypt($retainer->id)), "QRCODE",2,2) !!}</p>
                                                </td>
