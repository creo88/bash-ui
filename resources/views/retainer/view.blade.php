                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 table-striped">
                                            <tr>
                                                ...
                                                <th class="text-dark">@if($retainer->discount_apply==1){{__('Discount')}}@endif</th>
                                            ...
                                            @foreach($iteams as $key =>$iteam)
                                                ...
                                                <tr>
                                                    ...
                                                    <td> @if($retainer->discount_apply==1)
                                    ...
                                    <tr>
                                        <td>
                                            @if(!empty($payment->add_receipt))
                                                <a href="{{asset(Storage::url('uploads/retainerpayment')).'/'.$payment->add_receipt}}" download="" class="btn btn-sm btn-primary btn-icon rounded-pill" target="_blank"><span class="btn-inner--icon"><i class="ti ti-download"></i></span></a>
